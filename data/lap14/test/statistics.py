...
with open("/export/home/hk52025804/workshop_NTU/SA/data/lap14/test/sentence.txt", "r") as f:
    sent_data = f.readlines() 
with open("/export/home/hk52025804/workshop_NTU/SA/data/lap14/test/target.txt", "r") as f:
    ae_data = f.readlines() 
with open("/export/home/hk52025804/workshop_NTU/SA/data/lap14/test/opinion.txt", "r") as f:
    oe_data = f.readlines() 
with open("/export/home/hk52025804/workshop_NTU/SA/data/lap14/test/target_polarity.txt", "r") as f:
    sc_data = f.readlines() 
