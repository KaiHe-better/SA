...
with open("/export/home/hk52025804/workshop_NTU/SA/data/res14/dev/sentence.txt", "r") as f:
    sent_data = f.readlines() 
with open("/export/home/hk52025804/workshop_NTU/SA/data/res14/dev/target.txt", "r") as f:
    ae_data = f.readlines() 
with open("/export/home/hk52025804/workshop_NTU/SA/data/res14/dev/opinion.txt", "r") as f:
    oe_data = f.readlines() 
with open("/export/home/hk52025804/workshop_NTU/SA/data/res14/dev/target_polarity.txt", "r") as f:
    sc_data = f.readlines() 
